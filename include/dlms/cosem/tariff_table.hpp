...
class TariffTable : public CosemObject {
public:
    ...
    std::string class_name() const override { return "TariffTable"; }

    std::vector<uint8_t> data_;

    std::vector<AttributeAccess> get_attributes() const override {
        return {AttributeAccess{1, "logical_name", true}, AttributeAccess{2, "data", true}};
    }
